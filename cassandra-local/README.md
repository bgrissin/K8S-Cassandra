...
This concludes the local storage version of this lan, please more forward to the next step of this lab [here](https://github.com/bgrissin/K8S-Cassandra/blob/master/cassandra-px/README.md)
