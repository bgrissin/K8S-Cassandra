...
This lab can be run on many public or private platform.   Packet.net was chosen as the platform for these labs because it close resemblance to an on premises experience.
