For this test we use volumes that exist on on each host that are created by setting up PX to run as a daemonset and adding the storage volume configurations into a storageclass.
